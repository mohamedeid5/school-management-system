...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('libraries.index') }}">{{ __('main.libraries') }}</a></li>
...
<div class="card card-info card-outline shadow">
    ...
    <div class="card-body">
        <form action="{{ route('libraries.update', $library->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <a href="{{ route('libraries.index') }}" class="btn btn-secondary btn-lg px-4">{{ __('main.back') }}</a>
        </form>
    </div>
</div>
@endsection
