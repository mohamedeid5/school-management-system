    ...
    <div class="card card-primary card-outline shadow">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <a href="{{ route('teacher.online-classes.edit', $onlineClass->id) }}" class="btn btn-info btn-sm">
                    <i class="fa fa-edit"></i> {{ __('main.edit') }}
                </a>
                @endcan
                <a href="{{ route('teacher.online-classes.index') }}" class="btn btn-secondary btn-sm">
