...
<div class="container-fluid">
    <div class="card card-primary card-outline shadow">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('teacher.online-classes.create') }}" class="btn btn-success btn-sm shadow-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @endif
                            <a href="{{ route('teacher.online-classes.show', $class->id) }}" class="btn btn-primary btn-sm">
                                <i class="fa fa-eye"></i>
                            </a>
                            @can('update', $class)
                            <a href="{{ route('teacher.online-classes.edit', $class->id) }}" class="btn btn-info btn-sm">
                    ...
                    @include('teacher.online_classes.delete_modal')
                    @empty
                    <tr>
