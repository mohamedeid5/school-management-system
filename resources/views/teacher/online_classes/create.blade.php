...
@section('title', __('main.add_online_class'))

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('teacher.dashboard') }}">{{ __('main.dashboard') }}</a></li>
    <li class="breadcrumb-item"><a href="{{ route('teacher.online-classes.index') }}">{{ __('main.online_classes') }}</a></li>
    <li class="breadcrumb-item active">{{ __('main.add_online_class') }}</li>
@endsection
...
<div class="card card-success card-outline shadow">
    ...
    <div class="card-body">
        <form action="{{ route('teacher.online-classes.store') }}" method="POST">
            ...
            <div id="manual_join_url_wrapper" class="form-group" style="{{ old('type') === 'manual' ? '' : 'display:none;' }}">
            ...
            <div class="row">
                ...
                <div class="col-md-4 form-group">
                    ...
                    <input type="number" name="duration" value="{{ old('duration', 60) }}" min="15" max="480"
            ...
            <a href="{{ route('teacher.online-classes.index') }}" class="btn btn-secondary btn-lg px-4">{{ __('main.back') }}</a>
        </form>
    </div>
</div>
@endsection
