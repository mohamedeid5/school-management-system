...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('teacher.questions.index') }}">{{ __('main.questions') }}</a></li>
        ...
        <form action="{{ route('teacher.questions.update', $question) }}" method="POST">
            ...
            <div id="sa_section" style="display:none;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="correct_answer" id="sa_correct_answer"
            ...
            <a href="{{ route('teacher.questions.index') }}" class="btn btn-secondary btn-lg px-4">{{ __('main.back') }}</a>
        </form>
    </div>
</div>
@endsection
