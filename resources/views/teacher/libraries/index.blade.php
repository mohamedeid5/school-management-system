...
<div class="container-fluid">
    <div class="card card-primary card-outline shadow">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('teacher.libraries.create') }}" class="btn btn-success btn-sm shadow-sm">
                ...
                <table id="datatable" class="table table-bordered table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('teacher.libraries.show', $library->id) }}" class="btn btn-primary btn-sm">
                                    <i class="fa fa-eye"></i>
                                </a>
                                @can('update', $library)
                                    <a href="{{ route('teacher.libraries.edit', $library->id) }}" class="btn btn-info btn-sm">
                        ...
                        @include('teacher.libraries.delete_modal')
                        @empty
                        <tr>
