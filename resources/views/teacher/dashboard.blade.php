            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        ...
                        <a href="{{ route('teacher.sections.index') }}" class="text-muted">{{ __('main.sections_list') }}</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        <i class="fa fa-list mr-1" aria-hidden="true"></i>
                        <a href="{{ route('teacher.students.index') }}" class="text-muted">{{ __('main.students_list') }}</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        ...
                        <a href="{{ route('teacher.online-classes.create') }}" class="text-muted">{{ __('main.add_online_class') }}</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        <i class="fa fa-list mr-1" aria-hidden="true"></i>
                        <a href="{{ route('teacher.exams.index') }}" class="text-muted">{{ __('main.exams_list') }}</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-lg-6 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        <a href="{{ route('teacher.attendances.create') }}" class="text-muted">
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('teacher.students.index') }}" class="btn btn-sm btn-outline-success">
                            ...
                            <tbody>
                                @forelse($recentStudents as $student)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>
                                            <a href="{{ route('teacher.students.show', $student) }}" class="text-dark font-weight-bold">
                                                {{ $student->user?->name ?? '—' }}
                                            </a>
                                        </td>
            ...
            <div class="card card-statistics">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div>
                            <a href="{{ route('teacher.online-classes.create') }}" class="btn btn-sm btn-warning mr-2">
                                <i class="fa fa-plus mr-1"></i>{{ __('main.add_online_class') }}
                            </a>
                            <a href="{{ route('teacher.online-classes.index') }}" class="btn btn-sm btn-outline-warning">
