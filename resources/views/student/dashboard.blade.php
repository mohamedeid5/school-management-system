            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        ...
                        <a href="{{ route('student.subjects.index') }}" class="text-muted">{{ __('main.subjects') }}</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        <i class="fa fa-list mr-1"></i>
                        <a href="{{ route('student.exams.index') }}" class="text-muted">{{ __('main.exams_list') }}</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        <i class="fa fa-list mr-1"></i>
                        <a href="{{ route('student.online-classes.index') }}" class="text-muted">{{ __('main.online_classes_list') }}</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-statistics">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('student.subjects.index') }}" class="btn btn-sm btn-outline-primary">
                            {{ __('main.subjects') }}
                        </a>
                    </div>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('student.exams.index') }}" class="btn btn-sm btn-outline-danger">
                            {{ __('main.exams_list') }}
                        </a>
                    </div>
                    <div class="table-responsive">
            ...
            <div class="card card-statistics">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('student.online-classes.index') }}" class="btn btn-sm btn-outline-warning">
