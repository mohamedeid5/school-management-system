...
<div class="container-fluid">
    <div class="card card-primary card-outline shadow">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('online-classes.create') }}" class="btn btn-success btn-sm shadow-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @endif
                            <a href="{{ route('online-classes.show', $class->id) }}" class="btn btn-primary btn-sm">
                                <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('online-classes.edit', $class->id) }}" class="btn btn-info btn-sm">
                    ...
                    @include('online_classes.delete_modal')
                    @empty
                    <tr>
