...
<div class="container-fluid">
    ...
    <div class="card card-primary card-outline shadow mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('questions.create') }}" class="btn btn-success btn-sm shadow-sm">
                    <i class="fa fa-plus"></i> {{ __('main.add_question') }}
                </a>
                <a href="{{ route('exams.edit', $exam) }}" class="btn btn-info btn-sm shadow-sm">
                    <i class="fa fa-edit"></i> {{ __('main.edit_exam') }}
                </a>
                <a href="{{ route('exams.index') }}" class="btn btn-secondary btn-sm shadow-sm">
