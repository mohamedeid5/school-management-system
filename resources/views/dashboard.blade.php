            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        ...
                        <a href="{{ route('students.index') }}" class="text-muted">{{ __('main.students_list') }}</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        ...
                        <a href="{{ route('teachers.index') }}" class="text-muted">{{ __('main.teachers_list') }}</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        <i class="fa fa-list mr-1" aria-hidden="true"></i>
                        <a href="{{ route('classrooms.index') }}" class="text-muted">{{ __('main.classrooms_list') }}</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        ...
                        <a href="{{ route('attendances.index') }}" class="text-muted">{{ __('main.attendances') }}</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        <i class="fa fa-list mr-1" aria-hidden="true"></i>
                        <a href="{{ route('libraries.index') }}" class="text-muted">{{ __('main.libraries_list') }}</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-2 mb-0 mt-2 border-top">
                        <a href="{{ route('fee-invoices.index') }}" class="text-muted">
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('students.index') }}" class="btn btn-sm btn-outline-primary">{{ __('main.students_list') }}</a>
                    </div>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('fee-invoices.index') }}" class="btn btn-sm btn-outline-warning">{{ __('main.view') ?? 'View All' }}</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-hover table-sm">
                            <thead class="thead-light">
