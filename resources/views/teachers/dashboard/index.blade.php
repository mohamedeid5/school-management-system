            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        ...
                        <a href="{{ route('sections.index') }}" class="text-muted">{{ __('main.sections_list') }}</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        ...
                        <a href="{{ route('online-classes.create') }}" class="text-muted">{{ __('main.add_online_class') }}</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-lg-6 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        <a href="{{ route('attendances.create') }}" class="text-muted">
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('students.index') }}" class="btn btn-sm btn-outline-success">
                            ...
                            <tbody>
                                @forelse($recentStudents as $student)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>
                                            <a href="{{ route('students.show', $student) }}" class="text-dark font-weight-bold">
                                                {{ $student->user?->name ?? '—' }}
                                            </a>
                                        </td>
            ...
            <div class="card card-statistics">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div>
                            <a href="{{ route('online-classes.create') }}" class="btn btn-sm btn-warning mr-2">
