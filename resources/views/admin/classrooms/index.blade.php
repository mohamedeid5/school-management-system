...
@section('content')
        <div class="bg-white p-4 rounded shadow-sm">
            ...
            <form action="{{ route('admin.classrooms.index') }}" method="GET" class="mb-4">
         ...
         <form action="{{ route('admin.classrooms.destroySelected') }}" method="POST" id="bulk-delete-form" style="display: none;">
            @csrf
            @method('DELETE')
        </form>
