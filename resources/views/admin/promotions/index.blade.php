                ...
                <div class="card-header">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('admin.promotions.management') }}" class="btn btn-outline-primary btn-sm shadow-sm">
                                <i class="fa fa-level-up-alt"></i> {{ __('main.manage_promotions') }}
                            </a>

                            <a href="{{ route('admin.graduations.create') }}" class="btn btn-success btn-sm shadow-sm">
