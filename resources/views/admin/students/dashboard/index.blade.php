            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        ...
                        <a href="{{ route('admin.subjects.index') }}" class="text-muted">{{ __('main.subjects') }}</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-statistics">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('admin.subjects.index') }}" class="btn btn-sm btn-outline-primary">
                            {{ __('main.subjects') }}
                        </a>
                    </div>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('admin.exams.index') }}" class="btn btn-sm btn-outline-danger">
                            {{ __('main.exams_list') }}
                        </a>
                    </div>
                    <div class="table-responsive">
