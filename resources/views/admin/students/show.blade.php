...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.students.index') }}">{{ __('main.students') }}</a></li>
    ...
    <div class="col-md-3">
        <div class="card card-primary card-outline shadow-sm">
            <div class="card-body box-profile">
                ...
                <a href="{{ route('admin.students.edit', $student->id) }}" class="btn btn-primary btn-block"><b>{{ __('main.edit') }}</b></a>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-bordered table-sm text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('admin.students.download_attachment', $attachment->id) }}" class="btn btn-info btn-sm">
                                                    <i class="fa fa-download"></i>
                                                </a>

                                                <form action="{{ route('admin.students.delete_attachment', $attachment->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
