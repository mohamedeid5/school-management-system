                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right text-left" aria-labelledby="studentActions{{ $student->id }}">
                                    ...
                                    <a href="{{ route('admin.fee-invoices.show', $student->id) }}" class="dropdown-item">
                                        <i class="fa fa-file-invoice-dollar text-primary mr-1"></i> إصدار فاتورة
                                    </a>
                                    <a href="{{ route('admin.receipt-students.show', $student->id) }}" class="dropdown-item">
                                        <i class="fas fa-money-bill-wave text-success mr-1"></i> إصدار سند قبض
                                    </a>
                                    <a href="{{ route('admin.payment-students.show', $student->id) }}" class="dropdown-item">
                                        <i class="fas fa-hand-holding-usd text-success mr-1"></i> {{ __('main.add_payment') }}
                                    </a>
                                    <a href="{{ route('admin.processing-fees.show', $student->id) }}" class="dropdown-item">
