...
<div class="card card-success shadow-sm">
    ...
    <form action="{{ route('admin.students.update', $student->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="card-footer text-right">
            ...
            <a href="{{ route('admin.students.index') }}" class="btn btn-secondary">{{ __('main.cancel') }}</a>
        </div>
    </form>
</div>
@endsection
