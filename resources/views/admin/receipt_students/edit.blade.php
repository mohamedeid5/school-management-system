...
<div class="container-fluid">
    <div class="card card-warning card-outline shadow">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.receipt-students.update', $receipt_student->id) }}" method="POST" autocomplete="off">
                @csrf
                @method('PUT')
                ...
                <div class="text-right mt-3">
                    ...
                    <a href="{{ route('admin.receipt-students.index') }}" class="btn btn-secondary btn-lg shadow">{{ __('main.cancel') }}</a>
                </div>
            </form>
        </div>
    </div>
