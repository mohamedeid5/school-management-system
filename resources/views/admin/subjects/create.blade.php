...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.subjects.index') }}">{{ __('main.subjects') }}</a></li>
...
<div class="card card-success card-outline shadow">
    ...
    <div class="card-body">
        <form action="{{ route('admin.subjects.store') }}" method="POST">
            ...
            <a href="{{ route('admin.subjects.index') }}" class="btn btn-secondary btn-lg px-4">{{ __('main.back') }}</a>
        </form>
    </div>
</div>
@endsection
