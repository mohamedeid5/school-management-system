            ...
            <div class="card card-outline card-primary shadow">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.fees.create') }}" class="btn btn-success btn-sm shadow-sm">
                        ...
                        <table id="example1" class="table table-bordered table-striped table-hover text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('admin.fees.edit', $fee->id) }}" class="btn btn-info btn-sm" title="{{ __('main.edit') }}">
                                ...
                                @include('admin.fees.delete_modal')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
