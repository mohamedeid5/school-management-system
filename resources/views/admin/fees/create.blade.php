...
@section('title', __('main.add_fees'))

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('main.dashboard') }}</a></li>
    <li class="breadcrumb-item"><a href="{{ route('admin.fees.index') }}">{{ __('main.fees_list') }}</a></li>
    <li class="breadcrumb-item active">{{ __('main.add_new_fees') }}</li>
@endsection
            ...
            <div class="card card-primary card-outline shadow">
                <div class="card-header">
                    <h3 class="card-title text-primary font-weight-bold">
                        <i class="fa fa-money-bill-wave"></i> {{ __('main.add_new_fees') }}
                    </h3>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('admin.fees.store') }}" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="name[ar]" class="form-control @error('name.ar') is-invalid @enderror" value="{{ old('name.ar') }}">
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary btn-lg shadow">
                                <i class="fa fa-save"></i> {{ __('main.save_data') }}
                            </button>
                        </div>
                    </form>
                </div>
