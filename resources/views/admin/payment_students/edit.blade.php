...
<div class="container-fluid">
    <div class="card card-warning card-outline shadow">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.payment-students.update', $payment_student->id) }}" method="POST" autocomplete="off">
                @csrf
                @method('PUT')
                ...
                <div class="text-right mt-3">
                    ...
                    <a href="{{ route('admin.payment-students.index') }}" class="btn btn-secondary shadow">إلغاء</a>
                </div>
            </form>
        </div>
    </div>
