...
class LibraryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('teacher.libraries.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('teacher.libraries.create', compact('grades', 'subjects', 'classrooms', 'sections'));
    }
    ...
    public function store(LibraryRequest $request)
    {
        try {
            ...
            return redirect()->route('teacher.libraries.index');
        } catch (\Exception $e) {
    ...
    public function show(Library $library)
    {
        ...
        return view('teacher.libraries.show', compact('library'));
    }
    ...
    public function edit(Library $library)
    {
        ...
        return view('teacher.libraries.edit', compact('library', 'grades', 'subjects', 'classrooms', 'sections'));
    }
