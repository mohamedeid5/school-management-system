...
class OnlineClassController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('teacher.online_classes.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('teacher.online_classes.create', compact('grades', 'subjects', 'classrooms'));
    }
    ...
    public function show(OnlineClass $onlineClass)
    {
        ...
        return view('teacher.online_classes.show', compact('onlineClass'));
    }
    ...
    public function edit(OnlineClass $onlineClass)
    {
        ...
        return view('teacher.online_classes.edit', compact('onlineClass', 'grades', 'subjects', 'classrooms'));
    }
