...
class OnlineClassController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('online_classes.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('online_classes.create', compact('grades', 'subjects', 'teachers', 'classrooms'));
    }
    ...
    public function show(OnlineClass $onlineClass)
    {
        ...
        return view('online_classes.show', compact('onlineClass'));
    }
    ...
    public function edit(OnlineClass $onlineClass)
    {
        ...
        return view('online_classes.edit', compact('onlineClass', 'grades', 'subjects', 'teachers', 'classrooms'));
    }
